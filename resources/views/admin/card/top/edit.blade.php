...
<div class="content-page">
  ...
  <div class="row">
    <div class="col-xl-12">
      <div class="card">
        <div class="card-body">
          <form class="needs-validation" novalidate action="{{ route('top_card.update') }}" method="post">
            @csrf
                        ...
                        <label for="">Image</label>
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="file" class="form-control" name="img" id="" placeholder="" required>                                   
