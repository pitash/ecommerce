                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="text-lg-right mt-3 mt-lg-0">
                            ...
                            <a href="{{ route('center_card.index') }}" class="btn btn-danger waves-effect waves-light"><i class="ti-angle-double-left"></i> All Card</a>
                        </div>
                    </div><!-- end col-->
                </div> <!-- end row -->
            </div> <!-- end card-box -->
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body offset-1">
                    <form class="needs-validation" novalidate action="{{ route('center_card.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group position-relative mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="" placeholder="RINGS" required>                                   
