...
<div class="content-page">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form class="form-inline">
                            <div class="form-group">
                                <h4 class="h3">Create Sub Category</h4>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="text-lg-right mt-3 mt-lg-0">
                            ...
                            <a href="{{ route('sub_category.index') }}" class="btn btn-danger waves-effect waves-light"><i class="ti-angle-double-left"></i> All Sub Category</a>
                        </div>
                    </div><!-- end col-->
                </div> <!-- end row -->
            </div> <!-- end card-box -->
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate action="{{ route('sub_category.store') }}" method="post">
                        @csrf
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group position-relative mb-3">
                                ...
                                <div class="col-md-12 ">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id=""><i class="fe-gitlab"></i></span>
                                        </div>
                            ...
                            <div class="form-group position-relative mb-3">
                                ...
                                <div class="col-md-10 ">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="sub_category" id="" placeholder="" required>                                   
                                        <div class="invalid-tooltip">
                                            Choose a unique Sub Category.
                                        </div>
                                    </div>
                                </div>
                            </div>
